...
//-- //Loading cookie parser module
const cookieParser = require('cookie-parser');
//-- //Instantiating cookie parser in middleware
...
app.get("/getcookie", function(req, res) { //Get cookie route
	//-- //Create constant COOKIE, set it to cookie cs386
	console.log('cookie:' + COOKIE); //Display cs386 property in console 	
	res.send("<h1>Home Page</h1><hr /><p>Cookie: " + COOKIE + " is in effect.</p>"); //Sending response including cookie object
});//Ending callback function curly brace, method app.get parenthesis
//Middleware
